...
Base_Propostas_Resumo_Aceitas_scaled = Funscaling.fit_transform(Base_Propostas_Resumo_Aceitas_3[['AVALIACOES','NUM_ESTILO_SECUNDARIO','NUM_ESTILO_PRINCIPAL','NUM_FORMACAO']])
Base_Propostas_Resumo_Aceitas_normalized = pd.DataFrame(Base_Propostas_Resumo_Aceitas_scaled,columns=['AVALIACOES','NUM_ESTILO_SECUNDARIO','NUM_ESTILO_PRINCIPAL','NUM_FORMACAO'])
Base_Propostas_Resumo_Aceitas_normalized.head(100)

Base_Propostas_Resumo_Aceitas_3[['AVALIACAO_ARTISTA','NUM_ESTILO_SECUNDARIO','NUM_ESTILO_PRINCIPAL','NUM_FORMACAO']] = Base_Propostas_Resumo_Aceitas_normalized
